...
public class VBLHeadphonesPurpleRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("musithy", "textures/entities/vbl_headphone_purple.png");
	private final Modelvbl_heapdhones model;

	public VBLHeadphonesPurpleRenderer() {
		this.model = new Modelvbl_heapdhones(Minecraft.getInstance().getEntityModels().bakeLayer(MusithyModLayerDefinitions.VBL_HEADPHONES_PURPLE));
	}
