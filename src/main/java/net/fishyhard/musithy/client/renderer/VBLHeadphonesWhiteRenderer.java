...
public class VBLHeadphonesWhiteRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("musithy", "textures/entities/vbl_headphone_white.png");
	private final Modelvbl_heapdhones model;

	public VBLHeadphonesWhiteRenderer() {
		this.model = new Modelvbl_heapdhones(Minecraft.getInstance().getEntityModels().bakeLayer(MusithyModLayerDefinitions.VBL_HEADPHONES_WHITE));
	}
