...
public class VBLHeadphonesRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("musithy", "textures/entities/vbl_headphone.png");
	private final Modelvbl_heapdhones model;

	public VBLHeadphonesRenderer() {
		this.model = new Modelvbl_heapdhones(Minecraft.getInstance().getEntityModels().bakeLayer(MusithyModLayerDefinitions.VBL_HEADPHONES));
	}
